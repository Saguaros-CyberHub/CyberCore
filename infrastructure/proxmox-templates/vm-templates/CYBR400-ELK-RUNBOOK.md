...
Two services now write into the baseline tree:

| | writes | purpose |
|---|---|---|
| `loggen-baseline` | `logs/current/logs.json` | log-generator's twelve generic sources |
| `cc-hostbase` | `logs/current/host.json` | benign host/process/file activity |
