...
ALTER TABLE cybercore_analysis_operation ADD COLUMN IF NOT EXISTS reset_plan JSONB;
...
CREATE INDEX IF NOT EXISTS ix_analysis_reset_predecessor
  ON cybercore_analysis_operation ((reset_plan->>'previousOperationId'));
